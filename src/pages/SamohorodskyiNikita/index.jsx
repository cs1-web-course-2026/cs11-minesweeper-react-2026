...
const MinesweeperReact = () => {
  ...
  // Керування таймером через useEffect
  useEffect(() => {
    if (status === 'process') {
  ...
  const handleOpenCell = (row, col) => {
    ...
    // Рекурсивна функція для відкриття порожніх зон
